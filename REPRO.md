...
| `orchestration_engine/characterization/out/phase2/ls_validation.json` | `python -m orchestration_engine.eval.ls_validate` | LS trace + Vitis 2025.2.1 cosim JSON | ece-rschsrv |
...
| `cost_model_3d/out/oe_experiment.json` | `python -m cost_model_3d.oe_kernel_graph` | Python 3 analytical | any |
